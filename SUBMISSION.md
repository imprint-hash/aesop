...
- Fables' weekly rewards can be claimed by anyone for anyone. 2,693 providers are owed $3,003, and the largest ($410.13) dry-runs fine for about half a cent of gas. Aesop does not send those: moving someone's money without being asked is not a feature. Only an address that opts in is claimed for.
